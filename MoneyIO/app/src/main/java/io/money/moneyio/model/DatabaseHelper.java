...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<Type> getUserTypes(String userID){
        ...
        out.add(new Type("TRUE", "Hrana", R.mipmap.ic_launcher));
        out.add(new Type("FALSE", "Naem", R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Kola",R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Remont", R.mipmap.ic_launcher));
        out.add(new Type("FALSE", "Party", R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Pokupki" , R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Sport", R.mipmap.ic_launcher));
        out.add(new Type("FALSE", "Gorivo", R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Za Doma", R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Otdih", R.mipmap.ic_launcher));
        out.add(new Type("FALSE", "Deca", R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Telefon" , R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Tok", R.mipmap.ic_launcher));
        out.add(new Type("FALSE", "Voda", R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Internet", R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Hrana", R.mipmap.ic_launcher));
        out.add(new Type("FALSE", "Naem", R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Kola",R.mipmap.ic_launcher));
        out.add(new Type("TRUE", "Remont", R.mipmap.ic_launcher));
