...
public class DatabaseHelperSQLite extends SQLiteOpenHelper {
    ...
    public List<Type> getUserTypes(String userID){
        ...
        out.add(new Type("true", names[30], R.drawable.music));
        out.add(new Type("true", names[31], R.drawable.pet));
        out.add(new Type("true", names[31], R.drawable.pet2));
        out.add(new Type("true", names[32], R.drawable.phone));
        out.add(new Type("false", names[33], R.drawable.phone));
        out.add(new Type("true", names[34], R.drawable.race));
        out.add(new Type("false", names[34], R.drawable.race));
        out.add(new Type("true", names[35], R.drawable.repear));
        out.add(new Type("false", names[36], R.drawable.self_employment));
        out.add(new Type("false", names[37], R.drawable.salary));
        out.add(new Type("false", names[38], R.drawable.saved_money));
        out.add(new Type("true", names[39], R.drawable.shoes));
        out.add(new Type("true", names[40], R.drawable.shopping2));
        out.add(new Type("true", names[41], R.drawable.skiing));
        out.add(new Type("true", names[42], R.drawable.sport));
        out.add(new Type("true", names[43], R.drawable.theatre));
        out.add(new Type("true", names[44], R.drawable.trip));
        out.add(new Type("true", names[45], R.drawable.tv));
        out.add(new Type("true", names[46], R.drawable.wedding));
        out.add(new Type("true", names[47], R.drawable.weed));
